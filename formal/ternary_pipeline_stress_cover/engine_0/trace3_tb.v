...
`endif
  ...
  always @(posedge clock) begin
    ...
    if (cycle == 1) begin
      PI_alpha <= 32'b00000000000000000000000000000000;
      PI_activation <= 8'b10000111;
      PI_valid_in <= 1'b1;
      PI_weight_enc <= 4'b0001;
      PI_inv <= 22'b0001000000110101101011;
      PI_rst_n <= 1'b1;
    end
    ...
    if (cycle == 2) begin
      PI_alpha <= 32'b00000000000000000000000000000000;
      PI_activation <= 8'b10000010;
      PI_valid_in <= 1'b1;
      PI_weight_enc <= 4'b0001;
      PI_inv <= 22'b0011111001111100011010;
      PI_rst_n <= 1'b1;
    end
    ...
    if (cycle == 3) begin
      ...
      PI_valid_in <= 1'b1;
      PI_weight_enc <= 4'b0000;
      PI_inv <= 22'b1101100100001101101000;
      PI_rst_n <= 1'b1;
    end
    ...
    if (cycle == 4) begin
      ...
      PI_valid_in <= 1'b1;
      PI_weight_enc <= 4'b0000;
      PI_inv <= 22'b1110100101011101011001;
      PI_rst_n <= 1'b1;
    end
    ...
    // state 8
    if (cycle == 7) begin
      PI_alpha <= 32'b00000000000000001000000000000000;
      PI_activation <= 8'b00000000;
      PI_valid_in <= 1'b0;
      PI_weight_enc <= 4'b0000;
      PI_inv <= 22'b0000000000000000000000;

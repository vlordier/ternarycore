...
#endif
            VL_FATAL_MT("../rtl/ternary_dot.v", 26, "", "DIDNOTCONVERGE: Settle region did not converge after '--converge-limit' of 10000 tries");
        }
...
VL_ATTR_COLD void Vternary_dot___024root___dump_triggers__ico(const VlUnpacked<QData/*63:0*/, 2> &triggers, const std::string &tag) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vternary_dot___024root___dump_triggers__ico\n"); );
    // Body
    if ((1U & (~ (IData)(Vternary_dot___024root___trigger_anySet__ico(triggers))))) {
        VL_DBG_MSGS("         No '" + tag + "' region triggers active\n");
    }
    if ((1U & (IData)(triggers[0U]))) {
...
VL_ATTR_COLD void Vternary_dot___024root___ctor_var_reset(Vternary_dot___024root* vlSelf) {
    ...
    vlSelf->ternary_dot__DOT__weighted = VL_SCOPED_RAND_RESET_I(9, __VscopeHash, 17988373188066100903ull);
